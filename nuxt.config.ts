export default defineNuxtConfig({
    ...
    app: {
        ...
        head: {
            title: '闲看：资源随心，娱乐无限',
            meta: [
                { name: 'keywords', content: '闲看, 开源, 免费资源搜索, 网盘搜索, 音乐下载, TVBox数据接口, 电视直播, 博客发布, 影视资源, 教学工具, 非商业用途' },
                { hid: 'description', name: 'description', content: '闲看是一个开源免费的资源搜索平台，提供网盘资源搜索、音乐下载、TV直播、TVBox接口地址以及博客发布等多项功能，打造丰富的影视音聚合体验，供学习与探索使用，不支持商业用途。' },
                ...
                { property: 'og:image', content: 'https://allapt.tk/logo.png' },
                ...
                { name: 'twitter:image', content: 'https://allapt.tk/logo.png' },
