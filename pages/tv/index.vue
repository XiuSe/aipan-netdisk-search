<script setup>
useHead({
    title: '闲看 - 电视直播与 Alist 数据源聚合播放',
    meta: [
        { charset: 'utf-8' },
        { name: 'viewport', content: 'width=device-width, initial-scale=1, shrink-to-fit=no' },
        { name: 'keywords', content: '闲看, 电视直播, Alist 数据源, 聚合播放, 在线电视' },
        { hid: 'description', name: 'description', content: '闲看提供最新的电视直播和 Alist 数据源聚合播放，轻松享受精彩内容！' },
        { name: 'author', content: '闲看团队' },
        { name: 'robots', content: 'index, follow' },
        { name: 'format-detection', content: 'telephone=no' },
        { property: 'og:title', content: '闲看 - 电视直播与 Alist 数据源聚合播放' },
        { property: 'og:description', content: '闲看提供最新的电视直播和 Alist 数据源聚合播放，轻松享受精彩内容！' },
        { property: 'og:type', content: 'website' },
        { property: 'og:url', content: "https://aipan.me/tv" }, // 动态获取当前页面的 URL
        { property: 'og:image', content: '/logo.png' }, // 替换为适当的缩略图链接
        { name: 'twitter:card', content: 'summary_large_image' },
        { name: 'twitter:title', content: '闲看 - 电视直播与 Alist 数据源聚合播放' },
        { name: 'twitter:description', content: '闲看提供最新的电视直播和 Alist 数据源聚合播放，轻松享受精彩内容！' },
